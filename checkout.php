    ...
    <form class="form">
        ...
        <div class="card-info">
            <div class="input_container">
                <label class="input_label">اسم حامل البطاقة</label>
                <input class="input_field" type="text" placeholder="اسم حامل البطاقة">
            </div>
            <div class="input_container">
                <label class="input_label">رقم البطاقة</label>
                <input class="input_field" type="number" placeholder="0000 0000 0000 0000">
            </div>
            <div class="input_container">
                <label class="input_label">تاريخ انتهاء البطاقة / CVV</label>
                <div class="split">
