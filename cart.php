        ...
        <div class="container">
            <div class="row items-start"> <!-- right side -->
                ...
                <div class="col-7-lg col-12-md col-12-sm"> <!-- start -left -->
                    <?php if ($selectCartResult->num_rows > 0) {
                        while ($row = $selectCartResult->fetch_assoc()) {
                            ...
                            <div class="pro-box d-flex items-center justify-between round-8 py-10 px-6 relative">
                                ...
                                <div class="pro-details d-flex items-center">
                                    <div class="img-pro"><img src="../<?php print_r( $selectProductResult->fetch_assoc()) ?>" alt="img"
                                                              width="450" height="450" loading="lazy" decoding="async">
                                    </div>
                                    <p class="name fs-20 fw-700"><?php echo $selectProductResult->fetch_assoc()['title'] ?></p></div> <!-- quantiy -->
                                ...
                                <div class="total-prices"><span class="price fs-30 fw-700"><?php echo($row['qty'] *  $selectProductResult->fetch_assoc()['price'])  ?></span> <span
