...
(1, 'منتج', 'uploads/products/3.png', 20, 15, 'منتج تجريبي', 2, 2),
(2, 'عطر سوفاج', 'uploads/products/2.png', 20, 15, 'هذا العطر يتميز برائحة فريدة وجذابة تأسر الحواس وتترك انطباعاً لا يُنسى. يمزج بين النفحات الزهرية والفواكه الطازجة مع لمسات من الأخشاب الدافئة، مما يخلق توازناً مثالياً بين الأناقة والجاذبية. يعكس هذا العطر الفخامة والأناقة، مما يجعله اختيارًا مثاليًا للمناسبات الخاصة واليومية على حد سواء. سيضفي هذا العطر لمسة من السحر والأنوثة أينما حلّ', 2, 2),
(3, 'منتج', 'uploads/products/1.png', 20, 15, 'هذه الساعة تمتاز بتصميمها العصري البسيط الذي يجمع بين الأناقة والعملية. تتميز بقرص ساعة مستطيل الشكل، مما يمنحها مظهرًا مميزًا ومتميزًا على المعصم. بفضل سوارها المصنوع من الفولاذ المقاوم للصدأ، تتميز الساعة بالمتانة والمظهر الأنيق في آن واحد', 2, 2),
(4, 'ساعة', 'uploads/products/pro-B0GtClVE_Z1nvIT8.webp', 20, 15, 'هذه الساعة تمتاز بتصميمها العصري البسيط الذي يجمع بين الأناقة والعملية. تتميز بقرص ساعة مستطيل الشكل، مما يمنحها مظهرًا مميزًا ومتميزًا على المعصم. بفضل سوارها المصنوع من الفولاذ المقاوم للصدأ، تتميز الساعة بالمتانة والمظهر الأنيق في آن واحد', 2, 2);
